...
if __name__ == "__main__":
    ...
    # Bangalore is intentionally disconnected (no edges) for this problem and should produce None in the adj list etc.
    ...
    assert (graph.dfs_names(2) == ['London', 'Shanghai', 'Mountain View', 'San Francisco', 'Berlin', 'Sao Paolo'])

    print("\nBreadth First Search")
    pp.pprint(graph.bfs_names(2))
    assert (graph.bfs_names(2) == ['London', 'Shanghai', 'Berlin', 'Sao Paolo', 'Mountain View', 'San Francisco'])
